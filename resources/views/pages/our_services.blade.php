...
@section('content')
    ...
    <!-- Image Header -->
    <img class="img-fluid rounded mb-4" src="{{asset('images/img/our_service.jfif')}}" alt="">

    <!-- Marketing Icons Section -->
    <div class="row">
      <div class="col-lg-4 mb-4">
        <div class="card h-100">
          <h4 class="card-header">@lang('Payments')</h4>
          <div class="card-body">
            ...
            <p>@lang('Payments are possible by bank transfer or via PayPal.  See link below.')</p>
          </div>
          <div class="card-footer">
            <a href="#" class="btn btn-primary">@lang('Learn More')</a>
          </div>
        </div>
      </div>
      <div class="col-lg-4 mb-4">
        <div class="card h-100">
          <h4 class="card-header">@lang('Cancellation policy')</h4>
          <div class="card-body">
      ...
      <div class="col-lg-4 mb-4">
        <div class="card h-100">
          <h4 class="card-header">@lang('Privacy policy')</h4>
          <div class="card-body">
          ...
          <div class="card-footer">
            ...
            <div class="col-lg-4 mb-4">
        <div class="card h-100">
          <h4 class="card-header">@lang('Booking')</h4>
          <div class="card-body">
