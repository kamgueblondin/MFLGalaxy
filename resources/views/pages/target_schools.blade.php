@extends('layouts.app')
    @section("title") @lang('Target Schools') | {{ config('app.name', 'MFLGalaxy') }} @endsection
@section('content')
     <!-- Page Heading/Breadcrumbs -->
     <h1 class="mt-2 mb-2">@lang('Target Schools')
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">@lang('Target Schools')</li>
    </ol>
    <div class="row">
      <!-- Map Column -->
